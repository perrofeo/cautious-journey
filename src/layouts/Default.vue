  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-green-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-4">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/ramon_logo.svg" class="w-20" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/ramon_logo.svg" class="w-20" alt="logo" /></g-link>
        </div>
        ...
        >
          ...
          <li class="mr-8 mb-6 lg:mb-0 hidden">
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/tag/coding/" class="text-copy-primary hover:text-gray-600">Coding</a>
            <g-link v-else to="/tag/coding/" class="text-copy-primary hover:text-gray-600">Coding</g-link>
          </li>
          <li class="mr-8 mb-6 lg:mb-0">
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a href="#" class="text-copy-primary hover:text-gray-600">
              <button class="bg-blue-500 hover:bg-blue-700 border font-bold py-2 px-4 rounded inline-flex inline-flex-between items-center">
                <svg class="fill-current w-5 h-5 mr-2" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 width="25px" height="25px" viewBox="0 0 25 25" enable-background="new 0 0 25 25" xml:space="preserve">
<g>
	<path fill="#000000" d="M0.061,25l1.757-6.423c-1.084-1.877-1.653-4.006-1.652-6.19C0.167,5.557,5.723,0,12.553,0
	...
	<path fill="#000000" d="M18.793,15.342c-0.079-0.13-0.284-0.207-0.593-0.361c-0.31-0.155-1.831-0.903-2.116-1.005
